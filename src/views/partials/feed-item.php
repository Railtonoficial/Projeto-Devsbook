    ...
    <div class="box-body">
        <div class="feed-item-head row mt-20 m-width-20">
            <div class="feed-item-head-photo">
                <a href="<?= $base; ?>/perfil/<?= $data->user->id; ?>"><img
                            src="<?= $base; ?>/media/avatars/<?= $data->user->avatar; ?>"/></a>
            </div>
            <div class="feed-item-head-info">
                <a href="<?= $base; ?>/perfil/<?= $data->user->id; ?>"><span
                            class="fidi-name"><?= $data->user->name; ?></span></a>
            ...
            <?php if ($data->mine): ?>
                <div class="feed-item-head-btn">
                    ...
                    <div class="feed-item-more-window">
                        <a href="<?= $base ?>/post/<?= $data->id ?>/delete">Excluir</i></a>
                    </div>
                </div>
            <?php endif; ?>
        </div>
        ...
        <div class="feed-item-comments">
                ...
                <?php foreach ($data->comments as $item) : ?>
                    <div class="fic-item row m-height-10 m-width-20">
                        <div class="fic-item-photo">
                            <a href="<?= $base; ?>/perfil/<?= $item['user']['id']; ?>"><img
                                        src="<?= $base; ?>/media/avatars/<?= $item['user']['avatar']; ?>"/></a>
                        </div>
            ...
            <div class="fic-answer row m-height-10 m-width-20">
                <div class="fic-item-photo">
                    <a href="<?= $base; ?>/perfil/<?= $data->user->id; ?>"><img
                                src="<?= $base; ?>/media/avatars/<?= $loggedUser->avatar; ?>"/></a>
                </div>
